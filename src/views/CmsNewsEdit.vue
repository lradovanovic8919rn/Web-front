        ...
        <div v-if="status==1">
          ...
          <div v-else>
                ...
                <b-form @submit="onSubmit">
                    ...
                    <b-form-group label="Category:" label-for="category" required>
                    ...
                    <b-button class="spacing" @click="clear()" variant="primary">CLEAR</b-button>
                    ...
                    <b-button class="spacing" type="submit" variant="primary">UPDATE</b-button>
                </b-form>
                </div>
          </div>
      </div>
...
<script>
  import {  mapState} from 'vuex';
    ...
    export default {
        ...
        methods:{
            onSubmit(e) {
                ...
                this.axios
                    .put(this.api+this.$route.params.id, news,{
                        headers: {
    ...
    mounted() {
        this.axios.
            get(this.apiCategory).then((response) => {
        ...
        this.axios
            ...
            .then((response) => {
                    ...
                    this.form.category=response.data.category.name,
                    this.form.tags=response.data.tags,
                    this.tagObj=response.data.tags,
